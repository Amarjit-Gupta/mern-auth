...
const EditData = () => {
    ...
    const getSingleData = async () => {
        let result = await fetch(`${DATAURL}/data/getSingleData/${index}`);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            if (!name || !price || !company || !category || !oldFile) {
                ...
                let result = await fetch(`${DATAURL}/data/updateSingleData/${index}`, {
                    method: "put",
                    body: formData
                });
            ...
            <div className="signup">
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="file-box">
                        ...
                        <div className="file-box2"><img src={`${DATAURL}/uploads/${oldFile}`} alt="" /></div>
